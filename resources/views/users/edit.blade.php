...
<head>
    ...
    <title>Modifier un utilisateur - Trésor Public du Bénin</title>
    <style>
        :root {
...
<body>
    ...
    <div class="section">
        <form method="POST" action="{{ route('users.update', $user) }}">
            ...
            <div class="form-group">
                <label>Nouveau mot de passe <span style="font-weight: normal; color: var(--text-muted); font-size: 0.85rem;">(laisser vide pour ne pas changer)</span></label>
